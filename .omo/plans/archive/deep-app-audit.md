> 🗄️ **ARCHIVED — HISTORICAL. Do NOT execute.** 2026-05-30 full-stack React-UI + perf audit. Its UI findings are superseded by the bake-off; its stability/bug findings were rolled into the M0 reconciliation. Live successors: UI → `.omo/plans/mvp-bakeoff-plan.md` + `.omo/bakeoff/VERDICTS.md`; stability → `.omo/audit/28-bug-reconciliation.md` + `.omo/audit/findings.md`.
