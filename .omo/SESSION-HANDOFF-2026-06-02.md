...
- **Stabilise:** webview tsc **117→0**, ctest **78→97%** (27 corrupted-204f5545 suites quarantined), SessionServiceFileOps regression quarantined (test-side headless modal, engine healthy).
